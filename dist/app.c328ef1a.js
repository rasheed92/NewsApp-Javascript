...
var news;
var vote = []; //make sure that all elments are being laoded on the page
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (vote.length == 0) {
              for (index = 0; index < content.articles.length; index++) {
                vote.push(1);
              }
            }
...
function createArticle(article, i) {
  return "\n\n    <article id=\"".concat(i, "\">\n      <img width=\"124px\" height=\"124px\" src=\"").concat(article.urlToImage, "\" alt=\"\">\n      <div id=\"text\">\n        <h1>").concat(article.title, "</h1>\n        <p>").concat(article.description, "</p>\n        <time>").concat(article.publishedAt, "</time>\n      </div>\n      <div id=\"voter\">\n        <img height=\"13px\" id=\"\" onclick=\"\" class=\"up\" src=\"").concat(require('./assets/upvote.svg'), "\" alt=\"\">\n        <div id=\"counter\"><p id=\"description").concat(i, "\">").concat(vote[i], "</p></div>\n        <img  height=\"13px\" class=\"down\" src=\"").concat(require('./assets/downvote.svg'), "\" alt=\"\">\n      </div>\n    </article>\n  ");
}

function count() {
  var upvote = document.getElementsByClassName('up');
  ...
  var downvote = document.getElementsByClassName('down');
  ...
  for (var index = 0; index < downvote.length; index++) {
    _loop2(index);
  }
}
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./assets/upvote.svg":"assets/upvote.svg","./assets/downvote.svg":"assets/downvote.svg"}],"C:/Users/rasheed/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/rasheed/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
